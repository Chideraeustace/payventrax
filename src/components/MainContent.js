...
const MainContent = () => {
  ...
  const testimonials = useMemo(
    () => [
      { name: 'John Doe', role: 'Affiliate Marketer', quote: 'Payventrax helped me earn $5,000 in my first month!', image: image1 },
      { name: 'Jane Smith', role: 'Blogger', quote: 'The tracking tools are fantastic and easy to use.', image: image1 },
    ],
    []
  );
  ...
  const team = useMemo(
    () => [
      { name: 'Alice Brown', role: 'Affiliate Manager', image: image1, social: { twitter: '#', linkedin: '#' } },
      { name: 'Bob Green', role: 'Marketing Lead', image: image1, social: { twitter: '#', linkedin: '#' } },
    ],
    []
  );
  ...
  return (
    <div className="font-sans text-white relative overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center p-8 bg-[#040000] text-center overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            Power Your Income with Payventrax
          </motion.h1>
          <motion.p
      ...
      <SectionDivider className="bg-[#1b1a1a]" />

      {/* Features Section */}
      <section id="features" className="py-20 bg-[#1b1a1a]">
      ...
      <SectionDivider className="bg-[#040000]" />

      {/* Services Section */}
      <section id="services" className="py-20 bg-[#040000]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.h2
            className="text-4xl font-bold text-center mb-16 text-white"
            initial={{ opacity: 0, y: 20 }}
      ...
      <section id="testimonials" className="py-20 bg-[#1b1a1a]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.h2
            className="text-4xl font-bold text-center mb-16 text-white"
            initial={{ opacity: 0, y: 20 }}
      ...
      {/* Team Section */}
      <section id="team" className="py-20 bg-[#040000]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.h2
            className="text-4xl font-bold text-center mb-16 text-white"
            initial={{ opacity: 0, y: 20 }}

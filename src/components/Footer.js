...
const Footer = ({ isScrollTopVisible }) => {
  ...
  return (
    <footer className="relative bg-gradient-to-t from-[#040000] via-[#1b1a1a] to-[#040000] text-white py-16 overflow-hidden">
      ...
      <div className="mt-16 text-center text-gray-500 text-sm">
        &copy; {new Date().getFullYear()} Payventrax. All rights reserved.
      </div>
